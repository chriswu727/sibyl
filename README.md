...
The latest formal three-repeat run is intentionally retained as a failed launch baseline in [`evals/results/live-retrieval-2026-07-21.json`](evals/results/live-retrieval-2026-07-21.json): trap safety and latency passed, while answer coverage, synthesis-ready bundle rate, and repeat stability did not. Sibyl remains a public beta until a dated run clears every threshold; offline checks alone are not release evidence.
